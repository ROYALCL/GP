...
<html>
<head>
    <title>Content Manage——添加用户</title>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
        ...
        <td class="main_locbg font2"><img src="${ctx}/img/pointer.gif">&nbsp;&nbsp;&nbsp;当前位置：用户管理 &gt; 添加用户</td>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="10" class="main_tab">
                    <tr>
                        <td class="font3 fftd">
                            <table>
                                <tr>
                                    <td class="font3 fftd">姓&nbsp;名：<input type="text" name="nickName" id="nickname"size="20"/></td>
                                    <td class="font3 fftd">登录名：<input name="name" id="name" size="20"/></td>
                                    <td class="font3 fftd">密&nbsp;码：<input name="passWord" id="passWord" size="20"/></td>
                                    <td class="font3 fftd">确认密码：<input name="passWord1" id="password1" size="20"/></td>
                                </tr>
                                <tr>
                                    ...
                                    <td class="font3 fftd">邮&nbsp;箱：<input type="text" name="email" id="email"
                                                                           size="20"/></td>

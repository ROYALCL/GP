    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#login-submit-btn").on("click", function () {
                ...
                if (!/^\w{4,20}$/.test($("#name").val())) {
                    msg = "登录名长度必须是6~20之间";
                } else if (!/^\w{4,20}$/.test($("#password").val())) {
                    msg = "密码长度必须是6~20之间";
                }
                if (msg != "") {
...
<div class="page-lock">
    <div class="page-logo" style="margin-bottom: 2px">
        <a class="brand" href="login.html"
           style="font-size: 22px; color: #FFF;"> 内容管理<font color="#FFCC00">CM</font><span
    ...
    <form action="/login" method="post" id="loginForm">
        <div class="page-body">
            ...
            <div class="page-lock-info">
                <span>&nbsp;</span><span style="padding-top: 5px"><font color="red">密码长度不合法！</font></span>
                <%--${message}--%>
                    ...
                    <div class="controls">
                        <div class="input-icon left">
                            <i class="icon-lock"></i> <input
                                ...
                                placeholder="密码" id="password" name="password"value="${password}">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="page-footer" style="color: #fff;float: left">
            兼容浏览器IE8+，最佳分辨率1280*800. <br>@ Graduation Project By Orchid
        </div>
    </form>
</div>

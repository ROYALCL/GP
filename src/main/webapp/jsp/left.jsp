    ...
    <table width="200" height="100%" border="0" cellpadding="0" cellspacing="0" class="left_nav_bg">
        ...
        <tr valign="top">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/img/left_nav_arrow.gif">&nbsp;&nbsp;<a
        ...
        <tr valign="top" id="submenu2" style="display: none">
            <td class="left_nav_bgshw" height="50">
                <p class="left_nav_link"><img src="${ctx}/img/left_nav_arrow.gif">&nbsp;&nbsp;<a href="job/selectJob"
        ...
        <tr valign="top">
            <td height="100%" align="center">
                <div class="copycct"><br/><strong>开发者：</strong><br><strong>13级计算机科学与技术</strong><br>网络工程与技术
                </div>
            </td>
        </tr>
        <tr>
            <td height="10"><img src="${ctx}/img/left_nav_bottom.gif" height="10"></img></td>
        </tr>
        <tr>
